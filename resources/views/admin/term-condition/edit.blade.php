...
<div class="card info-card revenue-card">
    ...
    <div class="card-body">
        <div class="pt-4">
            <form id="FormId" action="{{route('term-condition.update',$termCondition->id)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        ...
                        <div class="col-12">
                            ...
                            <textarea  class="form-control mt-1" name="conditions" id="description" placeholder="Enter term-conditions ">{{ $termCondition->conditions }}</textarea>
                        </div>
