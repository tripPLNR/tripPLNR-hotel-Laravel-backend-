...
<div class="card info-card revenue-card">
    ...
    <div class="card-body">
        <div class="pt-4">
            <form id="FormId" action="{{route('about-us.store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        ...
                        <div class="col-12">
                            ...
                            <textarea  class="form-control mt-1" name="conditions" id="description" placeholder="Enter about-us ">{{old('description')}}</textarea>
                        </div>
